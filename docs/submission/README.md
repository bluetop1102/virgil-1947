...
> 갱신 2026-08-10 · 배포 `gh-pages ef4453f`
...
| 대상 | URL | 상태 |
|---|---|---|
| 플레이 | https://bluetop1102.github.io/virgil-1947/ | **가동 · `gh-pages ef4453f`**(8/10, master `7f983b4`) — JUDGE 라운드 4세션(심문 긴장층·라디오 BGM·진술 단위 카메라·조작 카드·일시정지·렌더 정련) + 마감 수정(자막 어절 개행·조정표 Esc 행·저작자 표기 대비) |
