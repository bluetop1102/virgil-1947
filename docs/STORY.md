...
|---|---|---|---|
| `deitch` | 몸을 반 발 물리며 어깨가 돌아가고 시선이 숙박부로 떨어진다. 오른손은 카운터 선에서 멈춘다(플라스크 쪽 — 상판이 가려 하강은 관찰 불가, 2026-08-09 세트 기하 실측로 개정). 문장 끝 음량이 떨어진다. "제 기억으론"을 붙인다 | 숙박부 모서리를 반복해서 맞춘다 | 안경을 벗고 눈두덩을 누른다 |
