...
| 0:04–0:12 | 타이핑 자막 4줄: "1947년 10월 11일. LAPD 실종계." / "버질 호텔 942호. 손님이 이틀째 보이지 않는다." / "9층은 사흘째 수도가 나오지 않는다." / "호텔은 둘 다 신고하지 않았다." **(개정 2026-08-09 — 구판은 날짜·장소·수압·실종의 나열이라 수압이 왜 중요한지 읽히지 않았다. 4행이 두 이상 신호를 하나의 의심으로 묶어 X1(나는 누구·왜 여기)을 8초 안에 세운다)** | 타자기 타건음, 물소리 지속 |
...
## 감정 곡선 — 저작 의도 (X4 진실원 · 2026-08-07 신설)

> 사건 밀도(무사건 ≤3분)는 위 타임라인이, **강도 설계**는 이 절이 소유한다. 판정:
> grader-X X4(기획 — E2 완주 대본을 읽은 신선 에이전트의 재구성 곡선과 대조 · 이 절은
> 마스킹) · AAA-RUBRIC X4(본 — 완주자 5명의 종료 후 드로잉). E7 §1·§3의 연출 강도
> (카메라·룸톤·침묵)가 이 곡선을 소비한다. 형식: 5분 구간 × {감정 방향} × {강도 1~5}.

| 구간 | 감정 방향 | 강도 | 근거 행 (타임라인) |
|---|---|---|---|
| 0–5 | 기대 (낯선 공간의 흡인 → 첫 반박의 긴장) | 3 | 첫 30초 · 수색 · 2:45 C1 |
| 5–10 | 긴장 (첫 불협화음 — 열쇠 부분 시인·도일 통과. 대본 층 실측: 이완은 텍스트에 없다 — 아래 연출 조항) | 3 | 5:00 S4 · 7:00 도일 통과 |
| 10–15 | 긴장 (닦인 카펫·회색 팻말 — 공간이 말을 걸기 시작) | 3 | 10:30 복도 · 12:45 two-voices |
| 15–20 | 확신 (수색 몰입 — 발견의 리듬, 필적 인지. 상승 3→4) | 4 | 16:00–20:00 942호 5개소 |
| 20–25 | 연민·죄책 (붕괴는 처벌이 아니라 사람이 열리는 것 — 방향 전환, 강도 유지) | 4 | 21:00 C2 안경 · 23:30 944호 진입 |
| 25–30 | 충격 (넷째 장의 형체 — 죄책의 개방) | 4 | 26:30 C3 · 28:30 고해 |
| 30–35 | 긴장 (**정적** — 실루엣·낙서·층계창. 강도 대신 밀도를 낮춘다) | 4 | 30:00 페이즈 · 33:30 층계창 |
| 35–40 | 긴장 (비의 옥상 — 대면. 정점 5 도달) | 5 | 35:30 옥상 · 38:00 도일 |
| 40–45 | 확신·충격 (링크 연쇄 — "그 말이 자백이다". 정점 유지) | 5 | 40:00 L1 · 42:00 C4 · 44:00 L3 |
| 45–50 | 상실 (여운 — 물 빠지는 소리, 하강) | 3 | 46:00 엔딩 · 49:00 크레딧 |

**핵심 변곡 4 (X4 대조 지점 — ±2.5분 기준 시각. 전 지점이 신선 재구성 실측
5/5 수렴에 결박 — run `wf_a14567fb-849`)**:

| # | 시각 | 변곡 | 정의 |
|---|---|---|---|
| V1 | 5:00 | 기대 → 긴장 | 첫 비가역 학습(C1) 직후의 방향 전환 — "이 게임은 무르지 않는다" |
| V2 | 15:00 | 몰입 상승 (3→4) | 942호 수색 — 발견의 리듬이 수사를 가속한다 |
| V3 | 20:00 | 긴장·확신 → 연민 전환 | C2 붕괴 — 심문이 사람을 여는 행위임의 발견 (강도 유지, 방향만 바뀐다) |
| V4 | 45:00 | 정점 → 상실 하강 | 종결 — 여운은 고조가 아니라 물이 빠지는 소리다 |

**연출 층 이완·정적 조항 (진단 4의 직접 해소 — 본 판정 대상, 게이트 4)**:
대본 텍스트 재구성으로는 이완이 측정되지 않는다(실측: 5기 전원이 5–10을 긴장 3으로
읽음 — 텍스트는 전진 운동량만 전달한다). 이완·정적은 **연출 층이 소유**하고 게이트 4
본 판정(X4 곡선 드로잉)에서 실측한다:
- **이완 1건 (8:00–10:30 엘리베이터, 목표 체감 강도 2)**: 회차에서 유일하게 아무것도
  요구하지 않는 구간 — cin-act2(E7 §2)의 격자문·층 표시등·정적이 연출 소유자다.
- **정적 1건 (30:00–35:30, 사건 밀도 저하·강도 상승 금지)**: 3막 진입 직전의 감속 —
  보일러 저주파·실루엣·층계창 1.5초 감속(cin-act3). 강도를 올리지 않고 불안의 질만 바꾼다.
- 금지: 이 두 구간에 신규 사건·클러치를 배치하는 개정(이 구간의 사건은 관찰·연출형으로
  한정). 본 판정에서 이 두 구간의 체감 강도가 인접 구간보다 낮게 드로잉되지 않으면
  연출 실패로 계상한다.
...
- X4(감정 곡선): §감정 곡선이 저작 의도의 진실원 — 기획 판정은 grader-X P-X4(이 절
  마스킹 후 재구성 대조), 본 판정은 AAA-RUBRIC X4(게이트 4).
