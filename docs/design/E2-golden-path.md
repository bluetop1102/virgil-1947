...
| 5–10 | **이완** (심문 종료의 숨 고르기 — 라디오가 남긴 잔불안) | 2 | 7:00 종료 페이즈 · 8:00 엘리베이터(cin-act2 정적) |
| 10–15 | 긴장 (닦인 카펫·회색 팻말 — 공간이 말을 걸기 시작) | 3 | 10:30 복도 · 12:45 two-voices |
| 15–20 | 기대 (수색 몰입 — 발견의 리듬, 필적 인지로 상승) | 3 | 16:00–20:00 942호 5개소 |
| 20–25 | 충격·연민 (붕괴는 처벌이 아니라 사람이 열리는 것) | 4 | 21:00 C2 안경 · 23:30 944호 진입 |
| 25–30 | 충격 (넷째 장의 형체 — 죄책의 개방) | 4 | 26:30 C3 · 28:30 고해 |
| 30–35 | 긴장 (**정적** — 실루엣·낙서·층계창. 클라이맥스 직전의 감속) | 3 | 30:00 페이즈 · 33:30 층계창 |
| 35–40 | 긴장 (비의 옥상 — 대면) | 4 | 35:30 옥상 · 38:00 도일 |
| 40–45 | 확신→충격 (링크 연쇄 — "그 말이 자백이다") | 5 | 40:00 L1 · 42:00 C4 · 44:00 L3 |
| 45–50 | 상실 (여운 — 물 빠지는 소리, 하강) | 3 | 46:00 엔딩 · 49:00 크레딧 |

**핵심 변곡 4 (X4 대조 지점 — ±2.5분 기준 시각)**:

| # | 시각 | 변곡 | 정의 |
|---|---|---|---|
| V1 | 5:00 | 기대 → 긴장 | 첫 비가역 학습(C1) 직후의 방향 전환 — "이 게임은 무르지 않는다" |
| V2 | 21:00 | 긴장 → 충격·연민 상승 | C2 붕괴 — 심문이 사람을 여는 행위임의 발견 |
| V3 | 42:00 | 정점 5 도달 | C4 — 위조가 자백이 되는 순간 |
| V4 | 46:00 | 정점 → 상실 하강 | 종결 — 여운은 고조가 아니라 물이 빠지는 소리다 |

**이완·정적 설계 조항 (진단 4의 직접 해소 — 전 구간 고조는 곡선이 아니다)**:
- **이완 1건 (5–10, 강도 2)**: 다이치 심문 종료 → 엘리베이터 상승. 회차에서 유일하게
  아무것도 요구하지 않는 구간 — cin-act2(E7 §2)의 정적이 이 이완의 연출 소유자다.
- **정적 1건 (30–35, 강도 3 유지·사건 밀도 저하)**: 3막 진입 직전의 감속 — 보일러 소리·
  실루엣·층계창 1.5초 감속(cin-act3). 강도를 올리지 않고 불안의 질만 바꾼다.
- 금지: 이 두 구간에 신규 사건·클러치를 배치하는 개정(무사건 ≤3분 규칙은 유지하되,
  이 구간의 사건은 관찰·연출형으로 한정).
