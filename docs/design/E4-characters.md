...
새벽 두 시의 로비에도 사람이 있다 — 엘리베이터 앞을 린넨 카트가 말없이 지나가고,
닳은 팔걸이 쪽 소파에는 신문을 든 노인이 앉아 있다. 아직 아무도 아니지만, 나중에
9층에서 그 얼굴들을 다시 만나게 된다.
...
- **텔 채널 분리**: STORY §2의 신호는 두 채널로 나뉜다 — ①**신체 신호**(플라스크 손,
  ...
  스페인어 혼입, 과잉 정밀 시각, 되묻기, 응답 지연 — 프라이스의 "대답 전 반박자 늦다",
  **도일의 웃음 — "웃는다"·"웃음을 멈추지
