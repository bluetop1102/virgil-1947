...
export const SHOTS = {
  ...
  'interrogation-deitch': {
    // 구판 pos [0,1.42,1.35]→원점 응시는 다이치(-3.35,-4.25)를 프레임 좌단 밖으로 놓쳤다
    // (S-B HANDOFF — "텔 판정용 샷이 인물을 못 본다"). 심문 카메라 실측(푸시 1.82m·회피 -10°)에
    // 맞춰 데스크 앞에서 얼굴·양손을 잡는다.
    pos: [-2.90, 1.52, -2.49], target: [-3.35, 1.33, -4.25], fov: 44, time: 18, act: 1,
