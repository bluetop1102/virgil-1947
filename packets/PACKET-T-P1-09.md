...
- `T-P1-04` — 심문 1건 E2E — 소각 직렬화 포함 · 상태 done
...
<!-- 원문: docs/design/E5-interrogation.md § [구현] ⊂ E5 — 심문·판정 시스템 -->
...
<!-- 원문: docs/AAA-RUBRIC.md § 절대 실격 조건 (하나라도 걸리면 그 항목 점수는 0, 루프 재진입) ⊂ VIRGIL — AAA 판정 루브릭 v3 -->
