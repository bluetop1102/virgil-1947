...
<!-- 원문: docs/design/E2-golden-path.md § 완주 타임라인 (최선 루트, 50:00) ⊂ E2 — 골든 패스 (최선 루트 완주 시나리오) -->
...
<!-- 원문: docs/design/E2-golden-path.md § [구현] ⊂ E2 — 골든 패스 (최선 루트 완주 시나리오) -->
...
<!-- 원문: docs/design/E2-golden-path.md § 부록 B — 게이트 판정 캡처 대상 목록 (P2·P4 판정 입력) ⊂ E2 — 골든 패스 (최선 루트 완주 시나리오) -->
...
### 11.2 docs/ARCHITECTURE.md § 11. 코드 스타일
...
### E7 §2 — 2. 시네마틱 목록 (`narrative/cinematics.js` 발주 단위)

<!-- 원문: docs/design/E7-presentation.md § 2. 시네마틱 목록 (`narrative/cinematics.js` 발주 단위) ⊂ E7 — 연출·오디오·괴담 -->
| ID | 내용 | 대본 소유 |
|---|---|---|
