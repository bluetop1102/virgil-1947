...
const PLAN = arg('--plan')
const OUT = arg('--out', 'scratchpad/lit1/out')
const SHOT = arg('--shot', 'atmo-corridor-night')
const PORT = Number(process.env.SHOT_PORT || 5924)
const W = 1280, H = 720
...
try {
  ...
  await page.evaluate(async () => {
    ...
    window.__ATMOMOD__ = await import('/src/world/atmosphere.js')
