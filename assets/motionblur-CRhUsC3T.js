import{Ln as e,Nn as t,W as n,X as r,Z as i,ct as a,dt as o,fn as s,pn as c,xt as l,z as u}from"./three.core-_aCheQum.js";var d=`
varying vec2 vUv;
void main () {
  vUv = uv;
...
void main () { gl_FragColor = texture2D(uSrc, vUv); }`;function g(t,r){let i=new e(Math.max(1,t|0),Math.max(1,r|0),{format:l,type:u,minFilter:n,magFilter:n,depthBuffer:!1,stencilBuffer:!1,generateMipmaps:!1});return i.texture.colorSpace=``,i}var _=class{constructor(){this.scene=new s,this.cam=new a(-1,1,1,-1,0,1),this.mesh=new i(new o(2,2),null),this.mesh.frustumCulled=!1,this.scene.add(this.mesh)}draw(e,t,n){this.mesh.material=t;let r=e.autoClear;e.autoClear=!1,e.setRenderTarget(n??null),e.render(this.scene,this.cam),e.autoClear=r}};function v(e,t){return new c({defines:t??{},vertexShader:d,fragmentShader:e,depthTest:!1,depthWrite:!1,uniforms:{}})}var y=class{async init(e){let n=e.quality??{};this.enabled=n.motionBlur!==!1,this.tile=8,this.taps=n.name===`cinematic`?16:10,this.quad=new _,this.w=0,this.h=0,this.mTile=v(f,{TILE:this.tile}),this.mTile.uniforms={uVel:{value:null},uTexel:{value:new t},uShutter:{value:.5}},this.mNeighbor=v(p),this.mNeighbor.uniforms={uTile:{value:null},uTexel:{value:new t}},this.mBlur=v(m,{TAPS:this.taps}),this.mBlur.uniforms={uSrc:{value:null},uVel:{value:null},uNeighbor:{value:null},uDepth:{value:null},uNoise:{value:null},uInvProj:{value:new r},uRes:{value:new t},uShutter:{value:.5},uFrame:{value:0},uHasNoise:{value:0},uMaxLen:{value:90}},this.mBlit=v(h),this.mBlit.uniforms={uSrc:{value:null}}}setSize(e,t,n){this._alloc(e,t)}_alloc(e,t){if(this.w===e&&this.h===t)return;this.w=e,this.h=t;for(let e of[this.tileRT,this.nbRT,this.full])e?.dispose();let n=Math.max(1,Math.ceil(e/this.tile)),r=Math.max(1,Math.ceil(t/this.tile));this.tileRT=g(n,r),this.nbRT=g(n,r),this.full=g(e,t),this.mBlur.uniforms.uMaxLen.value=Math.max(16,Math.round(t*.07))}render(e){let t=e.targets?.hdr,n=e.targets?.velocity;if(!this.enabled||!t||!n)return;this._alloc(e.w,e.h);let r=e.renderer,i=this.mTile.uniforms;i.uVel.value=n.texture,i.uTexel.value.set(1/e.w,1/e.h),this.quad.draw(r,this.mTile,this.tileRT);let a=this.mNeighbor.uniforms;a.uTile.value=this.tileRT.texture,a.uTexel.value.set(1/this.tileRT.width,1/this.tileRT.height),this.quad.draw(r,this.mNeighbor,this.nbRT);let o=this.mBlur.uniforms;o.uSrc.value=t.texture,o.uVel.value=n.texture,o.uNeighbor.value=this.nbRT.texture,o.uDepth.value=e.depthTexture??t.depthTexture,o.uNoise.value=e.blueNoise??null,o.uHasNoise.value=+!!e.blueNoise,o.uInvProj.value.copy(e.matrices.invProj),o.uRes.value.set(e.w,e.h),o.uFrame.value=(e.frame??0)%64,this.quad.draw(r,this.mBlur,this.full),this.mBlit.uniforms.uSrc.value=this.full.texture,this.quad.draw(r,this.mBlit,t)}dispose(){for(let e of[this.tileRT,this.nbRT,this.full])e?.dispose();for(let e of[this.mTile,this.mNeighbor,this.mBlur,this.mBlit])e?.dispose()}};export{y as default};