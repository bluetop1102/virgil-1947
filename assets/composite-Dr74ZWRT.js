...
`;function d(e,t){return new n(e,t,{type:o,format:r,minFilter:i,magFilter:i,depthBuffer:!1,stencilBuffer:!1,generateMipmaps:!1})}var f=class{async init(n){this.src=n.targets.hdr.texture,this.bloomTex=null,this.exposure=null,this.mat=new a({uniforms:{tSrc:{value:null},tBloom:{value:n.targets.bloom.texture},tHalN:{value:null},tHalW:{value:null},tBlueNoise:{value:n.blueNoise},uHasBloom:{value:0},uExposure:{value:1},uLift:{value:new e},uGamma:{value:new e(1,1,1)},uGain:{value:new e(1,1,1)},uSaturation:{value:1},uContrast:{value:1},uHalation:{value:0},uHalGain:{value:.5},uHalNarrow:{value:.62},uHalWide:{value:2},uMidPivot:{value:.25},uMidSlope:{value:1},uMidWidth:{value:1.05},uShoulder:{value:.3},uShoulderK:{value:.38},uChromatic:{value:0},uVignette:{value:0},uFloor:{value:new e(6e-4,8e-4,.0014)},uToe:{value:.004},uGrain:{value:0},uAspect:{value:1},uNoiseScale:{value:new t(1,1)},uNoiseOffset:{value:new t},uTexel:{value:new t(1,1)}},vertexShader:s,fragmentShader:c,depthTest:!1,depthWrite:!1,blending:0});let r={vertexShader:s,depthTest:!1,depthWrite:!1,blending:0};this.matPre=new a({uniforms:{tSrc:{value:null},uSrcTexel:{value:new t},uExposure:{value:1},uT0:{value:.9},uT1:{value:2.6},uCompress:{value:.34}},fragmentShader:l,...r}),this.matBlur=new a({uniforms:{tSrc:{value:null},uStep:{value:new t}},fragmentShader:u,...r}),this.halA=d(1,1),this.halB=d(1,1),this.halN=d(1,1),this.halW=d(1,1),this.halTexel=new t,this.halStep={nx:1,ny:.42,wx:5,wy:1.8},this.halWideT={t0:12,t1:30},this.setSize(n.w,n.h,n)}setSize(e,t,n){let r=this.mat.uniforms;r.uAspect.value=e/t,r.uNoiseScale.value.set(e/64,t/64),r.uTexel.value.set(1/e,1/t);let i=Math.max(1,e>>2),a=Math.max(1,t>>2);this.halA.setSize(i,a),this.halB.setSize(i,a),this.halN.setSize(i,a),this.halW.setSize(i,a),this.halTexel.set(1/i,1/a),this.matPre.uniforms.uSrcTexel.value.set(1/e,1/t)}halation(e){let t=this.matPre.uniforms,n=this.matBlur.uniforms,r=this.halTexel,i=this.halStep;t.tSrc.value=this.src,t.uExposure.value=this.mat.uniforms.uExposure.value;let a=t.uT0.value,o=t.uT1.value;e.fsq(this.matPre,this.halA),n.tSrc.value=this.halA.texture,n.uStep.value.set(r.x*i.nx,0),e.fsq(this.matBlur,this.halB),n.tSrc.value=this.halB.texture,n.uStep.value.set(0,r.y*i.ny),e.fsq(this.matBlur,this.halN),t.uT0.value=this.halWideT.t0,t.uT1.value=this.halWideT.t1,e.fsq(this.matPre,this.halA),n.tSrc.value=this.halA.texture,n.uStep.value.set(r.x*i.wx,0),e.fsq(this.matBlur,this.halB),n.tSrc.value=this.halB.texture,n.uStep.value.set(0,r.y*i.wy),e.fsq(this.matBlur,this.halW),t.uT0.value=a,t.uT1.value=o}render(e){let t=this.mat.uniforms,n=e.look;t.tSrc.value=this.src,t.tBloom.value=this.bloomTex||e.targets.bloom.texture,t.uHasBloom.value=+!!this.bloomTex,t.uExposure.value=this.exposure??n.exposure,t.uLift.value.fromArray(n.lift),t.uGamma.value.fromArray(n.gamma),t.uGain.value.fromArray(n.gain),t.uSaturation.value=n.saturation,t.uContrast.value=n.contrast,t.uHalation.value=n.halation,t.uChromatic.value=n.chromatic,t.uVignette.value=n.vignette,t.uGrain.value=e.quality.grain?n.grainAmount:0,t.uNoiseOffset.value.copy(e.blueNoise.offset),t.uHalation.value>0&&this.halation(e),t.tHalN.value=this.halN.texture,t.tHalW.value=this.halW.texture,e.fsq(this.mat,null)}dispose(){this.mat.dispose(),this.matPre.dispose(),this.matBlur.dispose(),this.halA.dispose(),this.halB.dispose(),this.halN.dispose(),this.halW.dispose()}};export{f as t};