import{Fn as e,G as t,L as n,Ln as r,N as i,Tn as a,W as o,Z as s,c,en as l,fn as u,in as d,o as f,un as p,xt as m}from"./three.core-_aCheQum.js";import{a as h,i as g,n as _,o as v,r as y,t as b}from"./glsl-6T1IWhSU.js";var x=new f;x.setAttribute(`position`,new i([-1,-1,0,3,-1,0,-1,3,0],3));var S=new c,C=`precision highp float;
in vec3 position;
out vec2 vUv;
...
}`,E=[],D=null;function O(e){return D||(D=new s(x,e),D.frustumCulled=!1,D._scene=new u,D._scene.add(D)),D.material=e,D._scene}function k(e,n){return e.colorSpace=n,e.wrapS=e.wrapT=d,e.minFilter=t,e.magFilter=o,e.generateMipmaps=!0,e.channel=0,e}function A(e,t,n){let r=e.getRenderTarget(),i=e.autoClear;e.autoClear=!1,e.setRenderTarget(t),e.render(O(n),S),e.setRenderTarget(r),e.autoClear=i,n.dispose()}function j(t,i,o={},s=512,c=``){let u=new r(s,s,{type:a,format:m,depthBuffer:!1,stencilBuffer:!1,generateMipmaps:!0});k(u.texture,c);let d={uSeed:{value:0},uTexel:{value:1/s},uBump:{value:1},uP:{value:new e}};for(let e in o)d[e]=o[e];return A(t,u,new l({glslVersion:n,vertexShader:C,uniforms:d,fragmentShader:`${w}\nlayout(location = 0) out vec4 oCol;\n${i}`,depthTest:!1,depthWrite:!1})),E.push(u),u.texture}function M(t,i,o){let s=new r(o,o,{count:3,type:a,format:m,depthBuffer:!1,stencilBuffer:!1,generateMipmaps:!0}),c=Math.min(16,t.capabilities.getMaxAnisotropy());k(s.textures[0],p).anisotropy=c,k(s.textures[1],``).anisotropy=c,k(s.textures[2],``).anisotropy=c;let u=i.p||[0,0,0,0];return A(t,s,new l({glslVersion:n,vertexShader:C,fragmentShader:`${w}\n${i.glsl}\n${T}`,uniforms:{uSeed:{value:i.seed??1},uTexel:{value:1/o},uBump:{value:(i.bump??1)*o/1024},uP:{value:new e(u[0],u[1],u[2],u[3])}},depthTest:!1,depthWrite:!1})),E.push(s),{albedo:s.textures[0],normal:s.textures[1],orm:s.textures[2]}}var N=null;function P(e,t=512){return N||(N=j(e,`
float H (vec2 uv) {
...
varying vec3 vCWPos;
varying vec3 vCWNrm;
`;function B(e){return e?[e[0],1/Math.max(e[1],.001),e[2],1/Math.max(e[3],.001)]:[-1e4,0,1e4,0]}function V(t,n,r,i){let a=!!(n.parallax&&r.parallax),o=[n.triplanar?`T`:``,n.stochastic?`S`:``,a?`P`+r.parallaxSteps:``,n.flow?`F`:``].join(``),s={uCDetail:{value:i},uCTime:{value:0},uCA:{value:new e(n.triplanar||1,n.grungeScale??.35,n.grunge??.16,n.detailTile??4)},uCB:{value:new e(n.parallax??0,n.detail??.5,n.flow??0,n.ao??.6)},uCC:{value:new e(n.toks??1.4,n.damp??.3,n.specAA??20,n.specAAMax??.45)},uCD:{value:new e(...B(n.band))}};t.userData.cecil=s,t.defines=t.defines||{},n.triplanar?t.defines.CECIL_TRIPLANAR=``:n.stochastic&&(t.defines.CECIL_STOCH=``),a&&(t.defines.CECIL_POM=``),n.flow&&(t.defines.CECIL_FLOW=``);let c=[z,`uniform sampler2D uCDetail;`,`uniform float uCTime;`,`uniform vec4 uCA;`,`uniform vec4 uCB;`,`uniform vec4 uCC;`,`uniform vec4 uCD;`,`vec3 cecilAlb; vec3 cecilNrm; float cecilRgh; float cecilMtl; float cecilAo; float cecilAlp;`,b,y,n.triplanar?v({sharpness:n.triSharp??6}):``,n.stochastic?h({blendPower:n.stochPower??7}):``,a?g(r.parallaxSteps):``].join(`
`);return t.onBeforeCompile=e=>{for(let t in s)e.uniforms[t]=s[t];e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
`+c).replace(`#include <map_fragment>`,I).replace(`#include <normal_fragment_maps>`,L).replace(`#include <roughnessmap_fragment>`,`float roughnessFactor = cecilRgh;`).replace(`#include <metalnessmap_fragment>`,`float metalnessFactor = cecilMtl;`).replace(`#include <aomap_fragment>`,R)},t.customProgramCacheKey=()=>`cecil`+o,n.flow&&(t.onBeforeRender=()=>{s.uCTime.value=W()}),t.needsUpdate=!0,t}var H=null;function U(e){H=e}function W(){return H===null?typeof window<`u`&&window.__ENGINE__?window.__ENGINE__.time:0:H}export{F as a,P as i,j as n,U as o,M as r,V as t};