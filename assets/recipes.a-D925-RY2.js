...
void SURF (vec2 uv, out vec3 alb, out float rgh, out float mtl, out float ao, out float alp) {
  ...
  alp = 1.0;
}`},"wood.varnished.dark":{seed:23,mult:.5,bump:2.4,mat:{clearcoat:.42,clearcoatRoughness:.3,specularIntensity:1,envMapIntensity:1},opts:{grunge:.18,grungeScale:.58,detail:.35,detailTile:9,ao:.55,toks:1.2,damp:.22},glsl:`
