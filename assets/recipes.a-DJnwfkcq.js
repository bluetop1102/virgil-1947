import{t as e}from"./recipes.a-carpet-BcMBIMpU.js";var t={"marble.lobby.floor":{seed:11,mult:1,bump:3.2,mat:{clearcoat:.62,clearcoatRoughness:.11,sheen:.06,sheenRoughness:.55,sheenColor:1711138,envMapIntensity:1.15},opts:{triplanar:.4,grunge:.17,grungeScale:.3,detail:.28,detailTile:5,ao:.65,toks:1,damp:.34},glsl:`
...
void SURF (vec2 uv, out vec3 alb, out float rgh, out float mtl, out float ao, out float alp) {
  ...
  alp = 1.0;
}`},"wood.varnished.dark":{seed:23,mult:.5,bump:2.4,mat:{clearcoat:.42,clearcoatRoughness:.3,anisotropy:.45,anisotropyRotation:1.5708,specularIntensity:1,envMapIntensity:1},opts:{grunge:.18,grungeScale:.58,detail:.35,detailTile:9,ao:.55,toks:1.2,damp:.22},glsl:`
